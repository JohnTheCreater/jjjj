...
function RStoreDetails({ltr,half_ltr,ml_200,ml_100,oilName}) {
    ...
    <div className='flex'>
      <div className='  mx-20 mt-10 mb-40'>
        ...
        <div className='flex gap-3  mr-40 mt-20 flex-col'>
            ...
            <div className="p-4 mb-4 my-10 bg-white border border-gray-200 bg-gray-200 rounded shadow-xl">
